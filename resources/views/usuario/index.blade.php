...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
            <a href="{{ route('usuario.create') }}" class="btn btn-primary shadow-md mr-2">Nuevo Usuario</a>
        </div>
        <!-- BEGIN: Data List -->
                ...
                <tbody>
                    @foreach ($usuarios as $usuario)
                        <tr class="intro-x">
                            ...
                            <td class="w-40">
                                <div class="flex items-center justify-center {{ $usuario->active ? 'text-success' : 'text-danger' }}">
                                    <i data-lucide="check-square" class="w-4 h-4 mr-2"></i> {{ $usuario->active ? 'Active' : 'Inactive' }}
                                </div>
                            </td>
